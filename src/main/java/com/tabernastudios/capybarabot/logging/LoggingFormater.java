package com.tabernastudios.capybarabot.logging;
...
public class LoggingFormater extends Formatter {
    ...
    public String format(LogRecord record)
    {
        ...
        color = switch (record.getLevel().getName()) {
            ...
            case "FINE" -> ANSI_GREEN;
            case "WARNING" -> ANSI_YELLOW;
            case "CONFIG" -> ANSI_PURPLE;
            default -> ANSI_CYAN;
        };
        ...
        builder.append(" [");
        builder.append(loggingClass.substring(loggingClass.lastIndexOf(".") +1));
        builder.append("]");
